...
(function() {
    ...
    document.querySelector(".liste-sujets-nomiss").insertAdjacentHTML('beforebegin', '<h4>Jvc PasBan</h4><input type="text" id="nickname-input" /><button id="submit-button">GO</button><button id="coffee-button">☕</button>');
